      ...
      <Section id="featured-security" className="bg-secondary text-secondary-foreground relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              <div className="h-72 overflow-hidden relative">
                <img src={featuredStandardCabin} alt="First Cabins Standard Cabin" className="w-full h-full object-cover group-hover:scale-105 transition-smooth duration-500" />
                <span className="absolute bottom-3 left-3 bg-secondary/80 backdrop-blur px-3 py-1 rounded-full text-xs font-semibold text-accent">Standard Cabin</span>
              </div>
              <div className="p-6">
