                ...
                <div className={quoteProduct === "Security Cabins" ? "grid lg:grid-cols-2 gap-8 items-start" : "block"}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <textarea name="message" required rows={3} placeholder="e.g., Colour: White/Silver, Length: 6m, Width: 3m, AC & custom specs..." className="w-full px-4 py-3 rounded-xl border border-border bg-background focus:outline-none focus:ring-2 focus:ring-primary text-sm resize-none" />
                    </div>
