        ...
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center group">
            <div className="leading-none">
              <div className="font-display font-black text-2xl md:text-3xl text-foreground tracking-wide uppercase group-hover:text-primary transition-smooth">FIRST CABIN</div>
